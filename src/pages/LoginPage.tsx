...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin }) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const msg =
        err?.response?.data?.message || "Giriş doğrulaması başarısız.";
      console.log(
        "Status Code:",
        err.response
          ? err.response.status
          : "Sunucuya Ulaşılamadı (Network Error)"
      );
        ...
        <div className="login-container">
          ...
          <form onSubmit={handleSubmit} className="login-form">
            <div className="radio-group">
              <label
                className={
                  "radio-option" + (loginType === "tc" ? " active" : "")
                }
              >
                <input
                  type="radio"
              ...
              <label
                className={
                  "radio-option" + (loginType === "identity" ? " active" : "")
                }
              >
                <input
                  type="radio"
            ...
            {loginType === "tc" ? (
              <div className="input-wrapper">
                <label htmlFor="tc-kimlik" className="input-label">
                  T.C. Kimlik No
                </label>
                <input
                  id="tc-kimlik"
                  ...
                  value={tcKimlik}
                  onChange={(e) =>
                    setTcKimlik(e.target.value.replace(/\D/g, ""))
                  }
              ...
              <div className="input-wrapper">
                <label htmlFor="pasaport-no" className="input-label">
                  Pasaport No
                </label>
                <input
                  id="pasaport-no"
